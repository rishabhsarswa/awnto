...
function loadXMLDoc(uname,pass,good_name,captcha) 
{
	var login_message = document.getElementById("login_message");
    ...
    //if ( this.readyState == 4) {
    	login_message.innerHTML = "connection done " +  this.readyState+":"+this.status + ";" + this.responseText  ;
      	...
      	if(obj.err == 0 )
      	{
      		...
      		awnto_setCookie('awnto_app_user',obj.awnto_user,30);
		awnto_setCookie('awnto_app_user_key',obj.awnto_user_key,30);
...
function loadXMLDoc_check_user(uname) 
{
